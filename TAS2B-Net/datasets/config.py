...
_C.SEGMENTOR.SPACE_ENCODER_TYPE = 'uemcadnet'
...
# EMCADNET specification
_C.EMCADNET = CN()
_C.EMCADNET.ENCODER = 'pvt_v2_b2'
_C.EMCADNET.EXPANSION_FACTOR = 2
_C.EMCADNET.KERNEL_SIZES = [1, 3, 5]
_C.EMCADNET.CHANNELS = [512, 320, 128, 64]
_C.EMCADNET.DW_PARALLEL = True
_C.EMCADNET.ADD = True
_C.EMCADNET.LGAG_KS = 3
_C.EMCADNET.ACTIVATION = 'relu'
_C.EMCADNET.NUM_CLASSES = 19
